...
public class FileCopierJMXImpl implements FileCopier {
	...
	@ManagedOperationParameters( { @ManagedOperationParameter(name = "srcDir", description = "Source directory"), @ManagedOperationParameter(name = "destDir", description = "Destination directory"), @ManagedOperationParameter(name = "filename", description = "File to copy") })
