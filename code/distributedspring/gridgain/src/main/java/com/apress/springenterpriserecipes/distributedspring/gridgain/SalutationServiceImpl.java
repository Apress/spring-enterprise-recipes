 ...
 * @author Josh Long
 */
public class SalutationServiceImpl implements SalutationService, Serializable, ApplicationContextAware {
    ...
    public String saluteSomeoneInForeignLanguage(String recipient) {
        ...
        if (!languages.contains(language)) throw new java.lang.RuntimeException(
