...
/**
 * 
 * Service to handle working with Customers
 * 
 * This service handles CRUD as well as life cycle managment for a given
...
public interface CustomerService {
	...
	/**
	 * Authorizes a customer with certain privileges. In this simple example we
	 * merely afford them access to the system through a boolean flag.
	 * 
	 * @param customerId
	 */
